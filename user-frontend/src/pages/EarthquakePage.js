...
const EarthquakePage = () => {
  const { fetchEarthquakeData } = useData();
    ...
    <Box>
      <Box sx={{ textAlign: 'center', mb: { xs: 3, md: 4 } }}>
        ...
        <Typography variant="h6" color="text.secondary" sx={{ fontWeight: 400, fontSize: { xs: '0.875rem', sm: '1rem', md: '1.25rem' } }}>
          Sacred Seismic Protection for Mahakumbh
        </Typography>
      </Box>
      
      <Grid container spacing={3}>
        <Grid item xs={12} md={6}>
          <EarthquakeWidget data={earthquakeData} />
        </Grid>
          ...
          <Card className="dashboard-card">
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary">
                Detailed seismic monitoring information and analysis.
              </Typography>
            </CardContent>
          </Card>
        </Grid>
